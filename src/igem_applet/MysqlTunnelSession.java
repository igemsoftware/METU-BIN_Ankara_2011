...
public class MysqlTunnelSession {
     ...
     *
     * Calling this will render all JDBC Connection objects instantiated
     * through this object disconnected and unusable.
     */
    public void close() {
        if (session != null) {
            session.disconnect();
     ...
     * @throws JSchException when there was a connection or configuration problem.
     */
     ...
     *
     * @param database the database to get a Connection to.
